# Generated by Django 5.1 on 2025-07-18 02:34
...
def create_template_item(apps: AppConfig, name, template):
...
def create_default_template(apps: AppConfig, schema_editor):
    ...
    employee_template_item = create_template_item(apps, "employee", employee)
    voucher_template_item = create_template_item(apps, "voucher", base_voucher)
    ledger_template_item = create_template_item(apps, "ledger", base_ledger)
