...
from tests.utils import is_option_selected, is_template_used
...
def test_update_page(
    ...
    is_specialist_select = form.css_first("select[name='is_specialist']")
    ...
    assert is_option_selected(is_specialist_select, "Specialist")
...
def test_update_object(
    ...
    assert response.json()["is_specialist"] is True
