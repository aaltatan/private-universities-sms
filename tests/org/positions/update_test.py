...
def test_update_page(
    ...
    order_input_required_star = form.css_first(
        "div[role='group']:has(input[name='order']) span[aria-label='required field']"
    )
    ...
    assert order_input_required_star is not None
